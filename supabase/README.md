...
| `migrations/0004_cron.sql` | Enables `pg_cron` and schedules the once-a-minute sweep: deletes messages whose read timer (`expires_at`) has passed, and messages left unread for 24 hours. |
