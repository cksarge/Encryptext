...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Message deletion: a message is removed from our servers when the recipient reads it and 30 seconds elapse, when the sender deletes it, or when it has gone unread for 24 hours — whichever comes first. This deletes only the server-side copy. It does not and cannot prevent a recipient from screenshotting, photographing, copying, or otherwise retaining a message, and it does not remove copies stored on any device.',
